...
#added
import django.db.backends.mysql.base as mysqlbase

# Bypass Django's strict MariaDB/MySQL version check
mysqlbase.DatabaseFeatures.allows_group_by_selected_pks = True
